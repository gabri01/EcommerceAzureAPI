...
namespace DBContext.Migrations
{
    ...
    [Migration("20230511153205_Migrazione1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.IdentityModels.EcommerceAzureIdentityUser", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Models.IdentityModels.EcommerceAzureRole", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Models.StoredProceduresResult.spEsisteUtente", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("spEsisteUtente", t => t.ExcludeFromMigrations());
                });

            modelBuilder.Entity("Models.StoredProceduresResult.spGetOrdiniUtente", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("spGetOrdiniUtente", t => t.ExcludeFromMigrations());
                });

            modelBuilder.Entity("Models.StoredProceduresResult.spGetProdotti", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("spGetProdotti", t => t.ExcludeFromMigrations());
                });
            ...
            modelBuilder.Entity("Models.Tabelle.TAZIENDA", b =>
                {
                    ...
                    b.Property<long>("ProgerssivoFattura")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<long>", b =>
                {
                    b.HasOne("Models.IdentityModels.EcommerceAzureRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<long>", b =>
                {
                    b.HasOne("Models.IdentityModels.EcommerceAzureIdentityUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Models.Tabelle.TAZIENDA", b =>
                {
                    b.HasOne("Models.IdentityModels.EcommerceAzureIdentityUser", "IdUtenteNavigation")
                        .WithMany("Azienda")
