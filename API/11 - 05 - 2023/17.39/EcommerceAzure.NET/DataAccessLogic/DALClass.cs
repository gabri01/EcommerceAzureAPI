...
namespace DataAccessLogic
{
    public class DALClass : IDAL
    {
        ...
        public async Task<List<spGetProdotti>> GetProdottiAsync(int From)
        {
            ...
            return await Context.spGetProdotti.FromSqlRaw("EXECUTE spGetProdotti @From, @To", SqlPrm).ToListAsync();
        }
